...
def Tele(ccx):
    ...
    '__stripe_sid': '798a287b-b69e-427a-8a5d-57fb4dbe2aae1d2b79',
    }
    ...
    # 'cookie': '__stripe_mid=784e53e1-4cea-478b-bb9b-bc343c02d04438b2cd; __stripe_sid=798a287b-b69e-427a-8a5d-57fb4dbe2aae1d2b79',
    ...
    data = {
        'data': f'__fluent_form_embded_post_id=5442&_fluentform_1_fluentformnonce=b076d42cb9&_wp_http_referer=%2Fdonation%2F&names%5Bfirst_name%5D=Yangtaru&names%5Blast_name%5D=Ira&email=yangtaru686%40gmail.com&phone=%2B12028057096&input_text=13th%20Street%20Avenue&input_radio=Zakat&payment_input=Custom%20Amout&custom-payment-amount=0.50&message=&payment_method=stripe&__stripe_payment_method_id={pm}',
